...
export function EffectsOverlay() {
    ...
    const getFlashClass = () => {
        switch (activeEvent.type) {
            case 'four': return 'animate-flash-four';
            case 'six': return 'animate-flash-six';
            case 'wicket': return 'animate-flash-wicket';
            default: return '';
        }
    };
        ...
        <div className="fixed inset-0 pointer-events-none z-[100] overflow-hidden">
            ...
            {activeEvent.type === 'wicket' && (
                <div className="absolute inset-0 flex items-center justify-center">
                    <div className="text-white font-black text-6xl uppercase tracking-tighter opacity-20 select-none">WICKET!</div>
                </div>
            )}
        </div>
    );
