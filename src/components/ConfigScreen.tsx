...
import { type FormatType, GameState } from "../engine/GameState";
			...
			<div className="w-full max-w-md space-y-4">
				...
				<div className="bg-[#161B22] p-6 rounded-2xl border border-gray-800 space-y-4">
					...
					<div className="flex items-center gap-2">
						<TeamSelect
							value={t1}
							onChange={(v) => preventSame(v, true)}
							teams={teams}
						/>
						<span className="font-black text-gray-600 text-sm">VS</span>
						<TeamSelect
							value={t2}
							onChange={(v) => preventSame(v, false)}
							teams={teams}
							alignRight
						/>
					</div>
